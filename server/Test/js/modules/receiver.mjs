...
const transparentCanvasWebgl = document.querySelector(
  "canvas#transparent_receiver_webgl"
);
...
const incomingVideoEnabled = document.querySelector(
  "input#receiver_show_video"
);
const transparencyEnabled = document.querySelector(
  "input#receiver_show_transparency"
);
const transparencyWebGlEnabled = document.querySelector(
  "input#receiver_show_webgl_transparency"
);
...
transparencyWebGlEnabled.onclick = () => {
  ...
  transparentCanvasWebgl.parentElement.hidden =
    !transparentCanvasWebgl.parentElement.hidden;
};
